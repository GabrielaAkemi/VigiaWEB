...
// Importação do logo correto da aplicação VIGIA (ícone de ambulância)
...
export default function TermosDeUso() {
  ...
  return (
    // Adicionado relative overflow-hidden para comportar o background absoluto perfeitamente
    <div className="min-h-screen bg-gradient-to-br from-background to-muted p-4 md:p-8 relative overflow-hidden">
      
      {/* TEXTURA DE LOGO AO FUNDO (CENTRALIZADA E MARCA D'ÁGUA) */}
      <div className="absolute inset-0 pointer-events-none z-0 flex items-center justify-center overflow-hidden">
        <img 
          src={logoApp} 
          alt="" 
          className="w-[900px] h-[900px] object-contain opacity-[0.04] grayscale brightness-125 select-none"
        />
      </div>

      {/* Adicionado relative z-10 para manter o conteúdo na frente do logo do fundo */}
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="mb-8">
          ...
          <div className="flex items-center justify-center gap-4 mb-8">
            {/* CONTAINER DA LOGO NO TOPO: Removido shadow/background e tamanho aumentado */}
            <div className="w-24 h-24 flex items-center justify-center backend-none">
              <img 
                src={logoApp} 
                alt="Logo VIGIA" 
            ...
            <div className="text-center">
              <h1 className="text-2xl font-bold text-foreground font-poppins">VIGIA</h1>
              <p className="text-sm text-muted-foreground font-medium">Marília - SP</p>
            </div>
          </div>
        </div>

        <Card className="shadow-2xl border border-primary/10 bg-card/95 backdrop-blur-sm rounded-3xl overflow-hidden">
          <CardHeader className="text-center pb-8">
            ...
            <CardTitle className="text-3xl font-bold text-foreground font-poppins">
              Termo de Compromisso e Uso da Plataforma VIGIA
            </CardTitle>
          ...
          <CardContent className="prose prose-gray max-w-none">
            <div className="space-y-6 text-foreground">
              <p className="text-muted-foreground leading-relaxed">
                ...
                VIGIA, sistema oficial da Secretaria Municipal de Saúde de Marília. O VIGIA foi criado para
              ...
              <div className="space-y-6">
                <section>
                  ...
                  <p className="text-muted-foreground mb-3">A Plataforma VIGIA tem por finalidade:</p>
                ...
                <section>
                  ...
                  <ul className="space-y-2 text-muted-foreground pl-4">
                    ...
                    <li>• Manter em sigilo suas credenciais de acesso, sendo responsável por qualquer activity realizada em sua conta.</li>
                ...
                <section>
                  ...
                  <ul className="space-y-2 text-muted-foreground pl-4">
                    ...
                    <li>• A Secretaria de Saúde compromete-se a adoptar medidas técnicas e administrativas adequadas para proteger os dados coletados, comunicando ao usuário qualquer incidente relevante de segurança.</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="space-y-2 text-muted-foreground pl-4">
                    ...
                    <li>• O VIGIA é uma ferramenta de apoio e transparência, mas sua utilização não cria qualquer direito automático à entrega de medicamentos.</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="space-y-2 text-muted-foreground pl-4">
                    <li>• Disponibilizar a Plataforma em caráter contínuo, salvo por motivos de manutenção ou fatores externos que impedam sua operação.</li>
